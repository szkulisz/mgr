 ...
 * 
 * 
 * Changed by Szymon Kulisz for steering invrted pendulum
 */
...
private:
	string name, path;
    float analogFrequency;  //defaults to 1 MHz
	float analogMax;        //defaults to 3.3V
    float analogMax2;       //defaults to 5V
...
public:
    ...
    virtual int calibrateAnalogMax2(float analogMax);
    virtual int analogWrite2(float voltage);
